...
const login = async (req, res) => {
  ...
  try {
    ...
    if (!existingUser.isVarified)
      return res.status(400).send("email is not varified");
    ...
    res
      .status(200)
      .send({ massage: "login Sussessfull", user: loggedUse, accessToken });
  } catch (error) {
